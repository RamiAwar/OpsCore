/*
    ...
    OpenGL loader generated by glad 0.1.33 on Sat Jan 25 22:41:21 2020.
...
typedef void* (APIENTRYP PFNWGLGETPROCADDRESSPRPB_PRIVATE)(const char*);
static PFNWGLGETPROCADDRESSPRPB_PRIVATE gladGetProcAddressPtr;
...
int open_gl(void) {
    ...
    if(libGL != NULL) {
        ...
        gladGetProcAddressPtr = (PFNWGLGETPROCADDRESSPRPB_PRIVATE) tmp;
...
typedef void* (APIENTRYP PFNGLXGETPROCADDRESSPRPB_PRIVATE)(const char*);
static PFNGLXGETPROCADDRESSPRPB_PRIVATE gladGetProcAddressPtr;
#endif
...
int open_gl(void) {
    ...
    for(index = 0; index < (sizeof(NAMES) / sizeof(NAMES[0])); index++) {
        ...
        if(libGL != NULL) {
            ...
            return 1;
#else
            gladGetProcAddressPtr = (PFNGLXGETPROCADDRESSPRPB_PRIVATE)dlsym(libGL,
