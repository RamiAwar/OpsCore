...
namespace oc {
	...
	protected:
		MouseButtonEvent(int button) : m_Button(button) {} // Constructor is protected to prevent creation by anyone except MouseButtonPressedEvent and MouseButtonReleasedEvents (subclasses)
		int m_Button;
	};
